...
const UUID = process.env.UUID || '26aa7e63-9383-48c3-ae49-d2b40b27661e';
const AUTO_ACCESS = process.env.AUTO_ACCESS || false;
const XPATH = process.env.XPATH || UUID.slice(0, 8);
const SUB_PATH = process.env.SUB_PATH || 'websub';
const DOMAIN = process.env.DOMAIN || 'freezehost.guangxi.cloudns.org';
const NAME = process.env.NAME || 'freezehost-xhttp-Vls';
